...
public class ApiClient {
    ...
    private String basePath = "https://api.swaggerhub.com";
    ...
    public ApiClient() {
        ...
        authentications.put("TokenSecured", new ApiKeyAuth("header", "Authorization"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.swaggerhub.com
